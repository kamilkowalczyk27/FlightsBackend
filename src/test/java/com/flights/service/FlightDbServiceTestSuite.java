...
public class FlightDbServiceTestSuite {
    ...
    public void getAllFlightsTest() {
        //Given
        Flight flight1 = new Flight(1L, "Berlin", "London", 2.2, new Aircraft(1L,"Airbus a320", 11, 37 , new BigDecimal(870), new BigDecimal(30000), new BigDecimal(6150), new BigDecimal(5000), new BigDecimal(828)));
        Flight flight2 = new Flight(2L, "Madrid", "Moscow", 4.5, new Aircraft(1L,"Airbus a320", 11, 37 , new BigDecimal(870), new BigDecimal(30000), new BigDecimal(6150), new BigDecimal(5000), new BigDecimal(828)));
    ...
    public void getFlightTest() {
        //Given
        Flight flight = new Flight(1L, "Berlin", "London", 2.2, new Aircraft(1L,"Airbus a320", 11, 37 , new BigDecimal(870), new BigDecimal(30000), new BigDecimal(6150), new BigDecimal(5000), new BigDecimal(828)));
